...
/**
 * <items-dialog> — a caught Pokémon's training-aids dialog: held
 * Training item/Macho Brace, Pokérus, Exp. Share, Vitamins, Wings and
 * EV-reducing berries. Extracted out of caught-pokemon-detail.js (docs/
 ...
 */
export class ItemsDialog extends HTMLElement {
  constructor() {
    super();
    ...
    this.$dialog = /** @type {HTMLDialogElement} */ (shadow.querySelector('.item-dialog'));
    this.$close = shadow.querySelector('.item-dialog-close');
