...
import './ev-history-log.ts';
import './pokemon-search.ts';
import '../pages/parties/pokemon/nature.ts';
import '../pages/parties/pokemon/level.ts';
import '../pages/parties/pokemon/ivs.ts';
import '../pages/parties/pokemon/items.ts';
import '../pages/parties/pokemon/competitive.ts';
import '../pages/parties/pokemon/training-guide.ts';
