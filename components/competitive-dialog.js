...
/**
 * <competitive-dialog> — a caught Pokémon's competitive-reference
 * dialog: base stats, its Pokémon Showdown tier, and a few common
 * Smogon sets. Extracted out of caught-pokemon-detail.js (docs/adr/0008's
 ...
 */
export class CompetitiveDialog extends HTMLElement {
  constructor() {
    super();
    ...
    this.$dialog = /** @type {HTMLDialogElement} */ (shadow.querySelector('.competitive-dialog'));
    this.$close = shadow.querySelector('.competitive-dialog-close');
    ...
    this.$dialog.addEventListener('close', () => clearShadowDialogFlag());
