...
const SHELL_PATHS = [
  ...
  'version.json',
  'components/atoms/base-dialog.js',
  'components/atoms/ds-item-button.js',
  'components/atoms/ev-bar.js',
  'components/atoms/game-ball.js',
  'components/atoms/item-button-grid.js',
  'components/atoms/level-input.js',
  'components/molecules/ev-summary.js',
  'components/molecules/ev-training-guide.js',
  'components/molecules/game-version-picker.js',
  'components/organisms/pokemon-detail.js',
  'components/organisms/ev-history-log.js',
  'components/organisms/evolution-chain.js',
  'components/organisms/import-review.js',
  'components/organisms/pokemon-search.js',
  'components/organisms/transfer-panel.js',
  'lib/app-version.js',
  'lib/combobox.js',
  'lib/constants.js',
  ...
  'components/pages/parties/party-dialog.js',
  'components/pages/parties/parties.js',
  'components/pages/parties/pokemon/pokemon.js',
  'components/pages/parties/pokemon/nature.js',
  'components/pages/parties/pokemon/level.js',
  'components/pages/parties/pokemon/ivs.js',
  'components/pages/parties/pokemon/items.js',
  'components/pages/parties/pokemon/competitive.js',
  'components/pages/parties/pokemon/training-guide.js',
  'components/pages/parties/roster.js',
  'components/pages/settings/settings.js',
  'components/pages/settings/cache.js',
  'components/pages/transfer/transfer.js',
  'components/pages/transfer/export.js',
  'components/pages/transfer/import.js',
  'icons/icon-192.png',
