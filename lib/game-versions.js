// Known official game titles, one entry per title. Party.gameVersion
// itself stays a free text field — ROM hacks and fan games are always
// valid input; this list only decides whether we *also* recognize it,
// which drives both the party card's colored cartridge and Store's
// generation-dependent EV mechanics (vitamin cutoff, power item
// availability/bonus, Pokérus availability). Colors approximate each
