...
/** @typedef {{ page: 'settings'|'transfer'|'transfer-export'|'cache'|'import'|null, partySlug: string|null, pokemonUid: string|null, payload: string|null, dialog: 'create-party'|'edit-party'|null, returnTo: string|null }} Route */
...
export function currentRoute() {
  ...
  if (parts[0] === 'settings' && parts[1] === 'cache') {
    return { page: 'cache', partySlug: null, pokemonUid: null, payload: null, dialog: null, returnTo };
  }
  if (parts[0] === 'settings') {
    return { page: 'settings', partySlug: null, pokemonUid: null, payload: null, dialog: null, returnTo };
  }
  if (parts[0] === 'transfer' && parts[1] === 'export') {
    return { page: 'transfer-export', partySlug: null, pokemonUid: null, payload: null, dialog: null, returnTo };
  }
  if (parts[0] === 'transfer' && parts[1] === 'import') {
    return { page: 'import', partySlug: null, pokemonUid: null, payload: parts[2] || null, dialog: null, returnTo };
  }
  if (parts[0] === 'transfer') {
    return { page: 'transfer', partySlug: null, pokemonUid: null, payload: null, dialog: null, returnTo };
  }
  if (parts[0] === 'parties') {
    if (parts[1] === 'create') {
      return { page: null, partySlug: null, pokemonUid: null, payload: null, dialog: 'create-party', returnTo: null };
    }
    if (!parts[1]) {
      return { page: null, partySlug: null, pokemonUid: null, payload: null, dialog: null, returnTo: null };
    }
    if (parts[2] === 'edit') {
      return { page: null, partySlug: parts[1], pokemonUid: null, payload: null, dialog: 'edit-party', returnTo: null };
    }
    return { page: null, partySlug: parts[1] || null, pokemonUid: parts[2] || null, payload: null, dialog: null, returnTo: null };
  }
  return { page: null, partySlug: null, pokemonUid: null, payload: null, dialog: null, returnTo: null };
}
