...
const css = `
  *, *::before, *::after { box-sizing: border-box; }
  ...
  .ds-dialog {
    ...
    /* No top padding: the sticky .ds-dialog-header owns the top space.
       (A negative top margin on the header instead would break its
       stickiness — sticky constraints use the margin box, so it would
       pin below the scrollport top and let content peek out above.) */
