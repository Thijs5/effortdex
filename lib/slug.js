...
// (see lib/router.js) — a party can never claim one. "cache"/"export"/
// "import" don't need to be reserved too — they're only special one
// level down, under "settings"/"transfer" respectively.
const RESERVED_SLUGS = new Set(['settings', 'transfer']);
