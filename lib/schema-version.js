...
// write one).
//
// Starts at 1 to line up with the app's own v1.x release line. The two
// aren't linked mechanically — this number isn't derived from the git
// tag, and vice versa — but are kept numerically aligned by convention:
// a breaking change bumps this and, in the same release, the app's own
// SemVer major too, so "vN.0.0 shipped" and "schema version N" read as
// the same event (docs/adr/0009 §8).
