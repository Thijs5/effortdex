...
export class Store extends EventTarget {
  ...
  setPowerItem(uid, itemId) {
    ...
    this._append(entry, makeEvent('held-item', { powerItem, machoBrace: false }));
  ...
  setMachoBrace(uid, val) {
    ...
    entry.powerItem = powerItem;
    this._append(entry, makeEvent('held-item', { powerItem, machoBrace }));
    if (machoBrace) this.setExpShare(uid, false);
  }
  ...
  useVitamin(uid, vitaminId) {
    ...
    return this._append(
      entry,
      makeEvent('vitamin', { vitaminId, stat: y.stat, linkedStat: y.linkedStat, applied: y.applied, blockedByCutoff: y.blockedByCutoff, blockedByCeiling: y.blockedByCeiling })
    );
  }
  ...
  useFeather(uid, featherId) {
    ...
    if (!y) return null;
    return this._append(entry, makeEvent('feather', { featherId, stat: y.stat, applied: y.applied }));
  }
  ...
  useBerry(uid, berryId) {
    ...
    if (!y) return null;
    return this._append(entry, makeEvent('berry', { berryId, stat: y.stat, applied: y.applied }));
  }
