...
export function wireSpriteFallback(img) {
  // Same reasoning as constants.js's FALLBACK_ONERROR: without this, a
  // cross-origin sprite <img> loads in no-cors mode, so sw.js's cache-
  // first handler sees an opaque Response and never caches it for
  // ordinary browsing — see that file's comment for the full story.
