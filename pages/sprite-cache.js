...
// wireUtilityBackLink like Transfer/Import do: that helper returns to
// whatever party/roster content was last open, which is right for pages
// reachable from arbitrary places — this page has exactly one entry
// point (Settings' "Manage storage" button), so its back link always
