// One-off generator for test/fixtures/state-schema-1.json — NOT run by
...
const entry = store.catchPokemon({ id: 1, name: 'bulbasaur', sprite: 'bulbasaur.png', baseStats: { hp: 45, atk: 49, def: 49, spa: 65, spd: 65, spe: 45 } }, 5, 'adamant');
...
store.logDefeat(entry.uid, { name: 'rattata', sprite: 'rattata.png', evYield: { hp: 0, atk: 1, def: 0, spa: 0, spd: 0, spe: 0 } });
...
writeFileSync(new URL('./state-schema-1.json', import.meta.url), JSON.stringify(JSON.parse(raw), null, 2) + '\n');
console.log(raw);
